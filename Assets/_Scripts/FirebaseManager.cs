...
public class FirebaseManager : MonoBehaviour
{
    ...
    [SerializeField] private AccountInfoManager accountInfoManager;
    ...
    private IEnumerator Register(string _email, string _password, string _username)
    {
        ...
        if(_username.Equals("admin") || _username.Equals("Admin")) 
        {
            warningRegisterText.text = "Username is not allowed (username is reserved))";
        }
            ...
            else
            {
                ...
                if (User != null)
                {
                    ...
                    else
                    {
                        //Username is now set
                        SaveData();
                        DBreference.Child("TakenUsernames").Child(_username).SetValueAsync(_username);
